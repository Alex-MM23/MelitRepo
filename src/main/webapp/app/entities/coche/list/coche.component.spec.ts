...
import { sampleWithRequiredData } from '../coche.test-samples';
...
describe('Coche Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'coche', component: CocheComponent }]), HttpClientTestingModule, CocheComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to cocheService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCocheIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCocheIdentifier).toHaveBeenCalledWith(entity);
