...
import { sampleWithRequiredData } from '../modelo.test-samples';
...
describe('Modelo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'modelo', component: ModeloComponent }]), HttpClientTestingModule, ModeloComponent],
      providers: [
        {
