...
public class ClienteAsserts {
    ...
    public static void assertClienteUpdatableFieldsEquals(Cliente expected, Cliente actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getNumeroCompras()).as("check numeroCompras").isEqualTo(actual.getNumeroCompras()))
            .satisfies(e -> assertThat(e.getTier()).as("check tier").isEqualTo(actual.getTier()));
    }
